...
const Navbar = () => {
    ...
    return (
        <nav className="flexBetween w-full fixed z-10 p-4 flex-row border-b dark:bg-nft-dark bg-white dark:border-nft-black-1 boredr-nft-gray-1">
            <div>
                <Link href="/" >
